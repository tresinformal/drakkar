...
{
public:
  food(const double x = 2000.0, const double y = 1000.0, const color &c = color(), const int regeneration_time = 0, food_state food_state = food_state::uneaten, const double radius = 25.0);
