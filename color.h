...
public:
  ...
  constexpr int get_red() const noexcept { return m_r; }
  constexpr int get_green() const noexcept { return m_g; }
  constexpr int get_blue() const noexcept { return m_b; }

  /// Get the opaqueness(from the color) of the shelter (0 = transparant, 255 =
  /// opaque)
  constexpr int get_opaqueness() const noexcept { return m_a; }
